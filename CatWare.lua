...
Section:NewSlider("Anti-Aim", "These anti-aims make it so that the enemy will miss you.", 500, 0, function(s)
    local speed = s
...
Section:NewButton("Tracers", "The ESP analog.", function()
...
Section:NewToggle("Bunny-Hop", "Jumps automatically with added speed.", function(state)
    if state then
      while wait() do
...
Section:NewSlider("Walk-Speed", "Your walking speed.", 23, 16, function(s)
